...
public class RecentProductAdapter extends RecyclerView.Adapter<RecentProductAdapter.RecentProductViewHolder> {

    Context context;
    List<ProductUpdatedModel> list;

    public RecentProductAdapter(Context context, List<ProductUpdatedModel> list) {
    ...
    public RecentProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new RecentProductViewHolder(
    ...
    public void onBindViewHolder(@NonNull RecentProductViewHolder holder, int position) {
        try {
            ...
            Log.d(TAG_PRODUCT, "onViewCreated: "+e.getMessage());
        }
    }
