...
public class RecentOrderAdapter extends RecyclerView.Adapter<RecentOrderAdapter.OrderViewHolder> {
    ...
    public RecentOrderAdapter(Context context, List<OrderModel> list) {
    ...
    @NonNull
    @Override
    public RecentOrderAdapter.OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecentOrderAdapter.OrderViewHolder holder, int position) {
