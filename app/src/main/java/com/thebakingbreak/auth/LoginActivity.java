...
import static com.thebakingbreak.helper.Constant.TOKEN;
import static com.thebakingbreak.helper.Constant.USER_DB;
import static com.thebakingbreak.helper.Constant.VERIFICATION_MAIL;
...
import com.thebakingbreak.databinding.ActivityLoginBinding;
                                    ...
                                    if (value != null) {
                                        for (DocumentSnapshot snapshot : value.getDocuments()) {
                                            if (Objects.equals(snapshot.getString("email"), binding.emailAddressLogin.getText().toString().trim())) {
                                                if (Objects.equals(snapshot.getString("userType"), CUSTOMER)) {
